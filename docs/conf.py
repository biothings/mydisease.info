...
htmlhelp_basename = 'MyDiseaseinfodoc'
...
latex_documents = [
    (master_doc, 'MyDiseaseinfo.tex', 'MyDisease.info Documentation',
...
man_pages = [
    (master_doc, 'mydiseaseinfo', 'MyDisease.info Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'MyDiseaseinfo', 'MyDisease.info Documentation',
     author, 'MyDiseaseinfo', 'One line description of project.',
     'Miscellaneous'),
]
